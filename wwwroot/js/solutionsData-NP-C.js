...
(function(window) {
    ...
    window.SolutionsDataNP_C = [
    {
        ...
        "overview": {
            ...
            "mustHavesLegal": "The city needs authority to enumerate and identify chargeable municipal operating points under the relevant market, transport, parking, or public-space rules.",
            "mustHavesAdministrative": "Use a mapped inventory, simple IDs, and a basic register showing location, type, operational status, and payer or operator where known. Update it routinely.",
    ...
    },
    {
        ...
        "overview": {
            ...
            "mustHavesLegal": "The municipality needs authority to issue local operating tags, permits, or IDs for the relevant space or activity.",
            "mustHavesAdministrative": "Design a low-cost ID, keep a holder register, make display rules clear, and define how replacement, renewal, suspension, and reissue will work.",
            "usuallyNotBestFirstMove": [
    ...
    },
    {
        ...
        "overview": {
            ...
            "mustHavesLegal": "The municipality should have authority to record allocations, verify actual occupancy, and suspend or reassign spaces under clear local rules where they are inactive or used without authorization.",
            "mustHavesAdministrative": "Maintain a simple site map and allocation sheet, assign responsibility for updates, and run periodic walk-through checks. Every change of holder, vacancy, suspension, or reallocation should be logged with date and reason.",
            "usuallyNotBestFirstMove": [
            ...
            "politicalNote": "This is often sensitive where unofficial subletting has become tolerated, so start with clear communication and consistent documentation."
        },
        "fullDetails": {
    ...
    },
    {
        ...
        "overview": {
            ...
            "mustHavesLegal": "The approved tariff schedule must already exist and be available for disclosure.",
            "mustHavesAdministrative": "Use durable boards or posters, update them whenever the approved rates change, and make sure the wording is simple enough for daily users to understand quickly.",
            "usuallyNotBestFirstMove": [
    ...
    },
    {
        ...
        "overview": {
            ...
            "mustHavesLegal": "Usually no major legal change is needed if the matrix simply translates the approved schedule into operational form.",
            "mustHavesAdministrative": "Field-test the matrix, keep version control tight, and train collectors and supervisors together so everyone uses the same reference.",
            "usuallyNotBestFirstMove": [
                ...
                "These cards help the city turn known liabilities into actual payment and reduce leakage in handling the money."
            ]
        },
        "fullDetails": {
    ...
    },
    {
        ...
        "overview": {
            ...
            "mustHavesLegal": "Electronic records and digital receipts should be recognised for municipal collection purposes.",
            "mustHavesAdministrative": "Choose a tool that fits local connectivity and maintenance capacity, train staff well, and tie the system back to the site register and treasury reconciliation process.",
            "usuallyNotBestFirstMove": [
            ...
            "politicalNote": "Do not promise that automation alone will solve leakage. It needs to sit alongside supervision and clear operational controls."
        },
        "fullDetails": {
    ...
    },
    {
        ...
        "overview": {
            ...
            "mustHavesLegal": "Finance rules should already require official receipts and custody of receipt books. If not, an internal order can usually tighten this quickly.",
            "mustHavesAdministrative": "Keep a serial control log, record which book is issued to which collector, and require daily balancing with supervisor verification.",
            "usuallyNotBestFirstMove": [
    ...
    },
    {
        ...
        "overview": {
            ...
            "mustHavesLegal": "Finance rules should set clear timelines for deposit and reconciliation.",
            "mustHavesAdministrative": "Use same-day or next-day deposit rules, shift sheets, settlement reports, and an exception list for unexplained shortfalls that need immediate review.",
            "usuallyNotBestFirstMove": [
    ...
    },
    {
        ...
        "overview": {
            ...
            "mustHavesLegal": "No special legal reform is normally needed beyond the city’s standard authority for internal reporting.",
            "mustHavesAdministrative": "Use consistent site codes, ensure data entry is regular, and name one officer or supervisor who owns the dashboard and the follow-up discussion around it.",
            "usuallyNotBestFirstMove": [
    ...
    },
    {
        ...
        "overview": {
            ...
            "mustHavesLegal": "The city needs clear supervisory authority over collectors and deployment arrangements.",
            "mustHavesAdministrative": "Prepare a spot-check checklist, a route-rotation plan, and a short exception-review process that links directly to corrective action or discipline.",
            "usuallyNotBestFirstMove": [
    ...
    },
    {
        ...
        "overview": {
            ...
            "mustHavesLegal": "The municipality must be able to investigate staff misconduct and protect complainant information appropriately.",
            "mustHavesAdministrative": "Set up a hotline or WhatsApp number, keep a complaint log, define response times, and communicate back enough results to show the channel is real.",
            "usuallyNotBestFirstMove": [
                "Users do not trust the city enough to complain and there is no realistic plan for visible follow-up."
            ],
            "politicalNote": "If complaints are invited but not acted on, trust can fall further. This card only works when management will actually intervene."
        },
        "fullDetails": {
    ...
    },
    {
        ...
        "overview": {
            ...
            "mustHavesLegal": "The municipality needs clear contractual or regulatory authority to set remittance rules, documentation standards, audit rights, sanctions, and termination conditions for delegated collectors.",
            "mustHavesAdministrative": "Use a standard contract, daily or shift-based reconciliation, required display of approved tariffs, numbered or digital receipts, spot checks, and a complaint channel that bypasses the collector. Review performance regularly rather than only at contract renewal.",
            "usuallyNotBestFirstMove": [
            ...
            "politicalNote": "This reform often matters most where outsourced collection is politically connected; management should prepare for resistance and rely on documented controls rather than informal understandings."
        },
        "fullDetails": {
    ...
    },
    {
        ...
        "overview": {
            ...
            "mustHavesLegal": "The city needs clear sanction powers under the relevant market, transport, parking, or public-space rules.",
            "mustHavesAdministrative": "Document each enforcement step, authorise the right officers, and define how access is restored after compliance so enforcement stays rules-based.",
            "usuallyNotBestFirstMove": [
                "No lawful sanction exists.",
                "Visible enforcement would create major conflict because the political backing is not there."
            ],
            "politicalNote": "Early action should focus on repeat evaders and clearly unauthorised operators, not on one-off mistakes or vulnerable users."
        },
        "fullDetails": {
    ...
    },
    {
        ...
        "overview": {
            ...
            "mustHavesLegal": "The municipality needs authority to offer a longer-period permit or prepaid arrangement under the current tariff framework.",
            "mustHavesAdministrative": "Maintain a holder register, use a clear verification method, and define refund, cancellation, and misuse rules so passes do not become tradable loopholes.",
            "usuallyNotBestFirstMove": [
                "User turnover is too high.",
                "Passes would be easily shared or traded and the municipality has no realistic control method.",
                "Selected references used to shape the library",
                "These overview cards are not written as academic summaries, but the structure and the tactics were reviewed against a small set of practical manuals and reform notes that are useful for later full-card development.",
                "Kelly, Roy; White, Roland; Anand, Aanchal. Property Tax Diagnostic Manual. World Bank, 2020.",
                "International Finance Corporation and World Bank. How to Reform Business Licenses, 2010.",
                "International Finance Corporation, Multilateral Investment Guarantee Agency, and World Bank. Policy Framework Paper on Business Licensing Reform and Simplification, 2010.",
                "Farvacque-Vitkovic, Catherine; Kopanyi, Mihaly. Municipal Finances: A Handbook for Local Governments. World Bank, 2014.",
                "OECD. User Charging for Government Services: Best Practice Guidelines and Case Studies, 2002.",
                "UNCDF. Leveraging Digital Technologies for Enhanced Local Revenue Collection and Management in Local Governments in Uganda, 2021."
            ]
        },
        "fullDetails": {
