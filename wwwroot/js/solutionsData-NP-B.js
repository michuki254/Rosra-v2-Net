...
(function(window) {
    ...
    window.SolutionsDataNP_B = [
    {
        ...
        "overview": {
            ...
            "mustHavesLegal": "The city should have authority to collect and update user information for billing and service-administration purposes.",
            "mustHavesAdministrative": "Use a short census form, route or zone sheets, and a reconciliation team that can decide quickly whether to add, merge, suspend, or correct each account found in the field.",
    ...
    },
    {
        ...
        "overview": {
            ...
            "mustHavesLegal": "The municipality needs authority to link operational service data to billing data under normal privacy protections.",
            "mustHavesAdministrative": "Create unique service point IDs, map them if possible, and reconcile regularly between engineering or operations units and the revenue team.",
            "usuallyNotBestFirstMove": [
    ...
    },
    {
        ...
        "overview": {
            ...
            "mustHavesLegal": "The relevant office needs authority to pass the necessary user details to the billing authority, usually through a standing instruction or simple interdepartmental agreement.",
            "mustHavesAdministrative": "Define the trigger list, use a short handover form or digital feed, and review monthly exceptions so the city can see where the trigger is not working.",
            "usuallyNotBestFirstMove": [
    ...
    },
    {
        ...
        "overview": {
            ...
            "mustHavesLegal": "The city needs authority to amend customer records on proof of occupancy, control, or service responsibility.",
            "mustHavesAdministrative": "Use a short change form, a simple document checklist, a clear service standard for updates, and a full audit trail of every account change.",
            "usuallyNotBestFirstMove": [
                ...
                "Liability application overviews",
                "These cards help the city apply the approved schedule, class, tariff, or usage basis more consistently."
            ]
        },
        "fullDetails": {
            ...
            "risksAndDesignNotes": [
                "Do not create accounts that cannot be matched to a real service point, user, or occupancy event. Weak account creation can produce a second round of billing disputes later.",
                "Where households are vulnerable, explain that better coverage is about fair billing and service continuity as much as it is about revenue.",
                "Liability-application full cards",
                "These cards are about making sure the city applies the approved class, tariff, band, exemption, or usage basis more consistently."
            ]
        }
    },
    {
        ...
        "overview": {
            ...
            "mustHavesLegal": "The city needs authority to issue administrative guidance under the existing tariff schedule. That is usually possible even when the formal tariff is fixed by law.",
            "mustHavesAdministrative": "Prepare short decision notes with worked examples, train staff, and require supervisor review for ambiguous or high-value cases.",
            "usuallyNotBestFirstMove": [
    ...
    },
    {
        ...
        "overview": {
            ...
            "mustHavesLegal": "The municipality should have authority to inspect, record, and use the relevant measurement basis for billing.",
            "mustHavesAdministrative": "Define a clear measurement protocol, equip field staff with simple tools, verify readings or proxies routinely, and document what happens when measurements fail or proxies are temporarily used.",
            "usuallyNotBestFirstMove": [
    ...
    },
    {
        ...
        "overview": {
            ...
            "mustHavesLegal": "Every relief rule should have a written basis. Where existing rules are broad, the city can often still issue administrative guidance on evidence requirements and approval authority.",
            "mustHavesAdministrative": "Keep an exception register, require supporting documents, and review exempt or subsidised accounts periodically so management can spot drift early.",
            "usuallyNotBestFirstMove": [
                "Local politics treats discretionary fee relief as routine patronage and the leadership is not ready to tighten it."
            ],
            "politicalNote": "The city should protect genuine low-income and vulnerable users while tightening uncontrolled relief for better-off users."
        },
        "fullDetails": {
    ...
    },
    {
        ...
        "overview": {
            ...
            "mustHavesLegal": "The city or service provider needs authority to access meters or other measurement points and to apply clear temporary estimation rules where readings cannot be obtained.",
            "mustHavesAdministrative": "Define reading schedules, minimum evidence requirements, supervisor review of estimated bills, and exception reports for zero, very low, or highly volatile readings. Where digital tools are not available, even a paper route and exception log can help.",
            "usuallyNotBestFirstMove": [
            ...
            "politicalNote": "Users often accept stronger measurement discipline more easily than tariff changes because it can be framed as fairer billing rather than higher charges."
        },
        "fullDetails": {
    ...
    },
    {
        ...
        "overview": {
            ...
            "mustHavesLegal": "The city needs authority to issue standard bills and, where relevant, recognise digital notices.",
            "mustHavesAdministrative": "Maintain a stable billing calendar, use clear templates, and make sure every bill carries a usable account reference and contact point for questions or corrections.",
            "usuallyNotBestFirstMove": [
    ...
    },
    {
        ...
        "overview": {
            ...
            "mustHavesLegal": "The city needs authority to use third-party payment channels and, where relevant, accept instalment arrangements.",
            "mustHavesAdministrative": "Every payment must link clearly to the account, reconcile back to the ledger, and generate proof of payment. Payment-plan cases need a simple register and reminder system.",
            "usuallyNotBestFirstMove": [
                "Connectivity is too weak and no workable agent network exists.",
                "The administration cannot track instalment plans reliably."
            ],
            "politicalNote": "When payment plans are introduced, frame them as a compliance tool for the willing, not a reward for chronic non-payers."
        },
        "fullDetails": {
    ...
    },
    {
        ...
        "overview": {
            ...
            "mustHavesLegal": "The municipality needs clear authority to receive advance payment or stored credit and to define how unused balances, refunds, or account closure will be treated.",
            "mustHavesAdministrative": "Start with a limited pilot, define how prepayments are posted to individual accounts, and ensure every top-up or advance payment generates proof. The accounting treatment should be clear before launch.",
            "usuallyNotBestFirstMove": [
            ...
            "politicalNote": "This tends to work best when it is introduced as an additional option, not as the only way to pay."
        },
        "fullDetails": {
    ...
    },
    {
        ...
        "overview": {
            ...
            "mustHavesLegal": "The municipality needs authority to issue reminders and arrears notices through the chosen channels.",
            "mustHavesAdministrative": "Prepare templates, create a daily or weekly overdue list, define escalation trigger points, and stop reminders automatically once payment is posted.",
            "usuallyNotBestFirstMove": [
    ...
    },
    {
        ...
        "overview": {
            ...
            "mustHavesLegal": "Finance rules should require official receipts, reconciliation, and deposit procedures. If these are weak, a standing internal order can usually tighten practice quickly.",
            "mustHavesAdministrative": "Use numbered or digital receipts, separate collection from reconciliation, carry out daily or same-week balancing, and review exceptions while evidence is still fresh.",
            "usuallyNotBestFirstMove": [
    ...
    },
    {
        ...
        "overview": {
            ...
            "mustHavesLegal": "The city needs clear authority for the chosen sanction or arrangement and due-process safeguards, especially where essential services are involved.",
            "mustHavesAdministrative": "Define thresholds, issue warning notices, allow rapid reinstatement after payment or agreement, and keep an exemption list for critical users.",
            "usuallyNotBestFirstMove": [
            ...
            "politicalNote": "Start with commercial or non-vulnerable accounts so the rule is seen as credible and proportionate."
        },
        "fullDetails": {
            ...
            "risksAndDesignNotes": [
                ...
                "C. Daily or point-of-collection charges",
                "In this cluster, coverage usually means invisible payers, undocumented use of chargeable spaces, or weak visibility over who is operating where. Liability application means the frontline charge rule is unclear or inconsistently applied. Compliance means leakage at the point of collection, weak receipts, weak remittance control, weak supervision, or weak follow-up. The focus is on recurrent daily or point-of-collection charges rather than one-off fines, penalties, or capital receipts.",
                "These streams often leak in real time. That means compliance and control reforms are especially important, but they work better when site allocation, user visibility, and published rates are also clear.",
                "Coverage full cards",
                "These cards are about seeing the real base, creating the right accounts or operating-point records, and keeping those records usable over time."
            ]
        }
    }
];
